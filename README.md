<img width="1772" height="410" alt="Image" src="https://github.com/user-attachments/assets/49e49565-509a-4d69-aac5-6b86dc9a0b35" /> ## Forestudy
...
- iOS/Android 홈 화면에 추가해 PWA로 설치 가능, 실제 기기 화면에 맞춰 노치·홈 인디케이터 영역을 피해 전체 화면으로 표시

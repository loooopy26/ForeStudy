...
공부는 끝없는 의무처럼 느껴질 때가 많습니다.
Forestudy는 이러한 학습 경험을 게임처럼 즐겁고 지속 가능한 경험으로 바꾸기 위해 시작되었습니다.

AI가 학습을 분석하고 개인 맞춤형 퀘스트를 제공하며, 사용자는 공부를 통해 획득한 보상으로 캐릭터와 공간을 꾸미고 숲을 성장시킬 수 있습니다.
작은 새싹에서 시작한 숲은 사용자의 노력과 함께 점차 하나의 마을로 성장하며, 학습의 성장을 눈으로 확인할 수 있는 새로운 학습 경험을 제공합니다
